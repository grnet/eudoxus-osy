<%@ Page Title="Επεξεργασία Παραστατικού" MasterPageFile="~/PopUp.Master" Inherits="EudoxusOsy.Portal.Secure.EditorPopups.EditInvoice" CodeBehind="EditInvoice.aspx.cs" Language="C#" AutoEventWireup="true" %>
