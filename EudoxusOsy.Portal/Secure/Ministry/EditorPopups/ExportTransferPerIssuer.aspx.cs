...
{
    public partial class ExportTransferPerIssuer : BaseSecureEntityPortalPage
    {
        ...
        protected void btnSubmitHidden_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect(string.Format("~/Secure/GenerateTransferPerIssuerExcel.ashx?year={0}&month={1}&date={2}&SupplierKpsID={3}",
