<%@ Page Title="Επεξεργασία Κατάστασης" Language="C#" MasterPageFile="~/Secure/Ministry/Ministry.master" AutoEventWireup="true" CodeBehind="EditCatalogGroup.aspx.cs" Inherits="EudoxusOsy.Portal.Secure.Ministry.EditCatalogGroup" %>
...
<asp:Content ContentPlaceHolderID="cphSecureMain" runat="server">
    ...
    <asp:UpdatePanel runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <my:CatalogSearchFilters runat="server" ID="ucCatalogSearchFilters"></my:CatalogSearchFilters>
            <div class="gridViewTopButtons">
                <table>
                    <tr>
                        <td>
                ...
                <tr>
                    <td>
                        <my:CatalogsGridView ID="gvNotConnectedCatalogs" runat="server" HideInstitution="true" ClientInstanceName="gvNotConnectedCatalogs" DataSourceID="odsNotConnectedCatalogs"
                            OnCustomCallback="gvNotConnectedCatalogs_CustomCallback" OnHtmlRowPrepared="gvNotConnectedCatalogs_HtmlRowPrepared">
                            <Columns>
