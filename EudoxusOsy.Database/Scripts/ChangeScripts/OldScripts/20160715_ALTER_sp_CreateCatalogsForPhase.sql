...
Begin
	...
	-- Reduce price for 3% for every year after 5 years of FirstRegistration until 15% is reached
			...
			Begin
				...
				Begin
					...
					begin
						...
						Insert Into Catalog (CatalogType, PhaseID, BookID, SupplierID, DepartmentID, DiscountID, BookCount, Percentage, BookPriceID, Amount, State, Status, 
						CreatedAt, CreatedBy)
						Values (0, @PhaseID, @BookID, @SupplierId, @DepartmentID, @PreviousDiscountID, 
					...
					Insert Into Catalog (CatalogType, PhaseID, BookID, SupplierID, DepartmentID, DiscountID, BookCount, Percentage, BookPriceID, Amount, State, Status, 
					CreatedAt, CreatedBy)
					Values (0, @PhaseID, @BookID, @SupplierId, @DepartmentID, @BookDiscountID, 
		...
		Begin
			...
			Insert Into Catalog (CatalogType, PhaseID, BookID, SupplierID, DepartmentID, DiscountID, BookCount, Percentage, BookPriceID, Amount, State, Status, 
			CreatedAt, CreatedBy)
			Values (0, @PhaseID, @BookID, @SupplierId, @DepartmentID,CASE WHEN @BookDiscountID > 0 THEN @BookDiscountID ELSE @YearDiscountID END, 
			@BookCount, @Percentage, @BookpRiceID, @CatalogAmount, 0, 1, GETDATE(), 'sysadmin')
